...
# # SPI interface
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AP42} [get_ports pwm_io[0]     ]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AN40} [get_ports pwm_io[1]     ]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AN41} [get_ports pwm_io[2]     ]
